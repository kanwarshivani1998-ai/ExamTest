...
export function About() {
  ...
  return (
    <div className="space-y-4 pb-4">
      <h1 className="text-lg font-bold text-gray-900">{bi('About', 'परिचय', lang)}</h1>
      <Card><CardContent className="space-y-2 text-sm text-gray-700">

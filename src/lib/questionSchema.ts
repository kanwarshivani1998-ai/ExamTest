...
export const QuestionSchema = z.object({
  ...
  optionsEn: z.tuple([z.string().min(1), z.string().min(1), z.string().min(1), z.string().min(1)]),
  optionsHi: z.tuple([z.string().min(1), z.string().min(1), z.string().min(1), z.string().min(1)]),
